...
export default function Banner() {
  ...
  useGSAP(
    () => {
      ...
      // 3. Fan out images to their final positions (matching original code layout)
      masterTl
        .to(
          ".image-1",
          {
            x: "-50%", // Move much further left
            y: 1,
            rotation: -4,
            duration: 1,
            ease: "power2.out",
